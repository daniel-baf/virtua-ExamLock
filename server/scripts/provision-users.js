...
const USERS = [
  { email: 'daniel@vantumst.com', password: process.env.SEED_USER_PASSWORD, displayName: 'Daniel', role: 'teacher' },
  { email: 'danibaufu@gmail.com',  password: process.env.SEED_USER_PASSWORD, displayName: 'Dani',   role: 'student' },
];
