...
export default function StudentCard({
  ...
  return (
    <article className={`student-card ${requiresAttention ? 'student-card--attention' : ''} ${status === 'offline' ? 'student-card--offline' : ''}`}>
      ...
      <div className="student-card__body">
        <div className="student-card__copy">
          <div className="student-card__headline">
            ...
            {requiresAttention && <span className="student-chip student-chip--warning">Requiere revision</span>}
          </div>
          {requiresAttention && (
            <div className="student-card__attention-banner">
